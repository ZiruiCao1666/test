...
export default function CalendarScreen() {
  ...
  const overviewPanelNode = (
    <CalendarOverviewPanel
      styles={styles}
      visible={isConnected && selectedPanel === 'overview'}
      profileOverviewNode={profileOverviewNode}
      courseGradesOverviewNode={courseGradesOverviewNode}
      dueSoonOverviewNode={dueSoonOverviewNode}
      assignmentsOverviewNode={assignmentsOverviewNode}
    />
  );
  ...
  const calendarPanelNode = (
    <CalendarPlannerPanel
      styles={styles}
      visible={selectedPanel === 'calendar'}
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <CalendarPreviewSection
          ...
          calendarPanelNode={calendarPanelNode}
          taskSectionNode={taskSectionNode}
          overviewPanelNode={overviewPanelNode}
        />
      </ScrollView>

      <CalendarBottomSheets
        styles={styles}
        taskDatePickerVisible={taskDatePickerVisible}
        setTaskDatePickerVisible={setTaskDatePickerVisible}
        confirmTaskDatePicker={confirmTaskDatePicker}
        taskDateDraft={taskDateDraft}
        setTaskDateDraft={setTaskDateDraft}
        taskDateMonthAnchor={taskDateMonthAnchor}
        setTaskDateMonthAnchor={setTaskDateMonthAnchor}
        dateMarkersByDate={dateMarkersByDate}
        timePickerVisible={timePickerVisible}
        setTimePickerVisible={setTimePickerVisible}
        confirmTimePicker={confirmTimePicker}
        activeTimeField={activeTimeField}
        getTimePickerTitle={getTimePickerTitle}
        timeDraft={timeDraft}
        setTimeDraft={setTimeDraft}
        hourWheelRef={hourWheelRef}
        minuteWheelRef={minuteWheelRef}
        meridiemWheelRef={meridiemWheelRef}
        monthYearPickerVisible={monthYearPickerVisible}
        setMonthYearPickerVisible={setMonthYearPickerVisible}
        confirmMonthYearPicker={confirmMonthYearPicker}
        monthYearDraft={monthYearDraft}
        setMonthYearDraft={setMonthYearDraft}
        monthYearOptions={monthYearOptions}
        calendarDetailVisible={calendarDetailVisible}
        setCalendarDetailVisible={setCalendarDetailVisible}
        setSelectedCalendarItem={setSelectedCalendarItem}
        safeSelectedCalendarItem={safeSelectedCalendarItem}
        selectedCalendarDetailSubtitle={selectedCalendarDetailSubtitle}
        selectedCalendarDetailNode={selectedCalendarDetailNode}
        openUrl={openUrl}
      />
    </SafeAreaView>
  );
